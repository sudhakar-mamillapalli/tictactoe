...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/sudhakar-mamillapalli/tictactoe/tictactoe/params
   */
   ...
   * @request GET:/sudhakar-mamillapalli/tictactoe/tictactoe/stored_game
   */
  queryStoredGameAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<TictactoeQueryAllStoredGameResponse, RpcStatus>({
      path: `/sudhakar-mamillapalli/tictactoe/tictactoe/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/sudhakar-mamillapalli/tictactoe/tictactoe/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<TictactoeQueryGetStoredGameResponse, RpcStatus>({
      path: `/sudhakar-mamillapalli/tictactoe/tictactoe/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
